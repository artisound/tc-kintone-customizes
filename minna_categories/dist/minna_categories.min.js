...
/******/ 	return __webpack_require__(__webpack_require__.s = "./minna_categories/source/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./minna_categories/source/index.js":
/*!******************************************!*\
  !*** ./minna_categories/source/index.js ***!
  \******************************************/
/*! no exports provided */
...
(function ($) {
  ...
  var fieldMap = fields.reduce(function (map, field) {
    return _objectSpread(_objectSpread({}, map), {}, _defineProperty({}, field["var"], field));
  }, {});
  kintone.events.on(['app.record.detail.show', 'app.record.create.show', 'app.record.edit.show'], /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(event) {
      var taxonomies, _loop, tax;
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              taxonomies = _context3.sent;

              _loop = function _loop(tax) {
                var space = kintone.app.record.getSpaceElement(tax);

                if (['app.record.create.show', 'app.record.edit.show'].includes(event.type)) {
                  if (space) space.innerHTML = "<btn-show-modal taxonomy=\"".concat(tax, "\"></btn-show-modal>");
                  /** **************************************************************************************************
                   * Vue コンポーネント
                   ************************************************************************************************** */
                  ...
                  Vue.component('btn-show-modal', {
                    ...
                    mounted: function () {
                      var _mounted = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                        ...
                        var field, input_outer, input, termIds, termNames, termInput, searchRef;
                            ...
                            switch (_context.prev = _context.next) {
                              case 0:
                                ...
                                if (fieldMap[this.taxField.fieldCode]) {
                                  // フィールド取得, スタイル変更
                                  field = document.querySelector(".value-".concat(fieldMap[this.taxField.fieldCode].id));
                                  ...
                                  field.style.overflowY = 'auto'; // 入力フィールドを隠す

                                  input_outer = field.querySelector(".input-text-outer-cybozu");
                                  input_outer.style.display = 'none'; // フィールドの値をselectedに格納

                                  input = field.querySelector('input');
                                  termIds = input.value.split(',');
                                  termNames = [];
                                  termIds.forEach(function (termId) {
                                    var term = _this.terms.find(function (v) {
                                      return v.term_id == termId;
                                    });

                                    if (term) {
                                      _this.selected.push(term);

                                      termNames.push(term.name);
                                    }
                                  });
                                  termInput = document.createElement('div');
                                  termInput.classList.add('term_names');
                                  field.appendChild(termInput);
                                  termInput.innerHTML = termNames.join('<br>'); // ref探す

                                  searchRef = setInterval(function (_) {
                                    if (_this.$refs[_this.taxonomy]) {
                                      // 値をもとにチェックを入れる
                                      _this.$refs[_this.taxonomy].setCheckedNodes(_this.selected);
                    ...
                    methods: {
                      get_taxonomy_hierarchy: function get_taxonomy_hierarchy($taxonomy) {
                        var _this2 = this;

                        var $parent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
                        console;
                        var terms = this.terms.filter(function (v) {
                          return v.parent == $parent;
                        });
                        var children = [];
                        terms.forEach(function ($term) {
                          $term.label = $term.name;
                          $term.children = _this2.get_taxonomy_hierarchy($taxonomy, $term.term_id);
                          children.push($term);
                        });
                        return children;
                      },
                      selectTerm: function selectTerm() {
                        // フィールド取得
                        var field = document.querySelector(".value-".concat(fieldMap[this.taxField.fieldCode].id)); // 選択されたタームを取得

                        var terms = this.$refs[this.taxonomy].getCheckedNodes(); // console.log(terms)
                        // 選択されたタームを格納

                        this.selected = terms; // フィールド取得

                        var input = field.querySelector("input");
                        var termInput = field.querySelector(".term_names"); // 選択されたタームのタームIDだけを抜き出し
                        ...
                        input.value = termIds.join(','); // ターム名をリスト表示（再構築）
                ...
                if (space) {
                  new Vue({
                    ...
                    mounted: function () {
                      var _mounted2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                        var field, input, termIds, termNames;
                            ...
                            switch (_context2.prev = _context2.next) {
                              case 0:
                                ...
                                if (event.type == 'app.record.detail.show') {
                                  ...
                                  if (fieldMap[this.taxField.fieldCode]) {
                                    field = document.querySelector(".value-".concat(fieldMap[this.taxField.fieldCode].id));
                                    input = field.querySelector("span");
                                    field.style.maxHeight = '180px';
                                    field.style.overflowY = 'auto';
                                    termIds = input ? input.innerText.split(',') : [];
                                    termNames = [];
                                    termIds.forEach(function (termId) {
                                      if (termId) {
                                        var term = taxonomies[tax].find(function (v) {
                                          return v.term_id == termId;
                                        });
                                        termNames.push(term.name);
                                      }
  ...
  kintone.events.on(['app.record.index.show', 'app.record.index.edit.show', 'app.record.edit.submit.success'], /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(event) {
      var taxonomies, _loop2, tax;
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              taxonomies = _context4.sent;

              _loop2 = function _loop2(tax) {
                var taxField = fieldMap[outputTaxField(tax, 'fieldCode')];

                if (taxField) {
                  var cells = document.getElementsByClassName("value-".concat(taxField.id));
                  cells.forEach(function (cell, i) {
                    if (event.type == 'app.record.index.edit.show') {
                      var input = cell.querySelector('input');

                      if (input) {
                        var termIds = input.value.split(',');
                        input.remove();
                        console.log(termIds);
                      ...
                      var _cellEl = cell.querySelector('.line-cell-gaia');

                      _cellEl.style.maxHeight = '100px';
                      _cellEl.style.overflow = 'auto';

                      var _taxEl = cell.querySelector('span');

                      if (_taxEl) {
                        var _termIds = _taxEl.innerText.split(',');

                        var _termNames = [];

                        _termIds.forEach(function (termId) {
                          if (termId) {
                            var term = taxonomies[tax].find(function (v) {
                              return v.term_id == termId;
                            });

                            _termNames.push(term.name);
                          }
                        });

                        _taxEl.innerHTML = _termNames.join('<br>');
                      }
                    }
                  });
                }
  ...
  function axios_tc_mysql(_x3) {
    return _axios_tc_mysql.apply(this, arguments);
  }

  function _axios_tc_mysql() {
    _axios_tc_mysql = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(param) {
      var ajax_url;
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ajax_url = "https://timeconcier.jp/forline/tccom/v2/tcLibMySQL/";
              _context5.next = 3;
              return axios({
                url: ajax_url,
                data: param,
                method: 'POST',
                headers: {
                  'Content-Type': param ? 'application/json' : 'multipart/form-data'
                },
                responseType: 'json'
              }).then(function (res) {
                if (res.status === 200) {
...
/******/ });
//# sourceMappingURL=minna_categories.min.js.map